...
var
  ...
  Text: String;
  wText: WideString;
  nWidth, nHeight, nX, nY, nI: Integer;
  BmpBuff: PRGBQuad;
  TextureBuff: PWord;
  btAlpha: Byte;
  index: Word;
