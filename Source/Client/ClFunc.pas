...
uses
  ...
  Grobal2, D7ScktComp, ExtCtrls, HUtil32, EdCode;
const
   DR_0      = 0;
   DR_1      = 1;
   DR_2      = 2;
...
//procedure BoldTextOut (surface: TDXTexture; x, y, fcolor, bcolor: integer; str: string);
...
begin
   ...
   if MsgNum = 1 then DScreen.AddSysMsg (iname + '굳랙君.');
