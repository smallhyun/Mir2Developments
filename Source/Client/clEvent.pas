...
uses
  ...
  HGETextures, Grobal2, D7ScktComp, ExtCtrls, HUtil32, EdCode;
...
type
   ...
   public
      ...
      procedure DrawEvent (backsurface: TDXTexture; ax, ay: integer); dynamic;
...
procedure TClEvent.DrawEvent (backsurface: TDXTexture; ax, ay: integer);
begin
