...
type
  ...
  private
    ...
    function FindExternalLibrary(LibraryName: AnsiString): INTEGER;
    function LoadExternalLibrary(LibraryName: AnsiString): INTEGER;
    function GetExternalLibraryHandle(LibraryName: AnsiString): HINST;
  public
    constructor Create;
    destructor Destroy; override;
    function Load(Stream: TStream): BOOLEAN;
    function Unload: BOOLEAN;
    function FindExport(FunctionName: AnsiString): POINTER;
...
function TDLLLoader.FindExternalLibrary(LibraryName: AnsiString): INTEGER;
var
  I: INTEGER;
begin
  RESULT := -1;
...
function TDLLLoader.LoadExternalLibrary(LibraryName: AnsiString): INTEGER;
begin
...
function TDLLLoader.GetExternalLibraryHandle(LibraryName: AnsiString): LONGWORD;
var
  I: INTEGER;
begin
  RESULT := 0;
...
function TDLLLoader.FindExport(FunctionName: AnsiString): POINTER;
var
  I: INTEGER;
begin
  RESULT := nil;
